...
class CardChart1Year extends Component {
  ...
  render() {
    ...
    const labelsYears = labelsAll.slice(0, 252)
    const priceArrayYears = priceArrayAll.slice(0, 252)
...
export default connect(mapStateToProps)(CardChart1Year)